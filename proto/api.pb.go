...
func (*PingMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_a08210bad39cce6a, []int{0}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_a08210bad39cce6a) }

var fileDescriptor_api_a08210bad39cce6a = []byte{
